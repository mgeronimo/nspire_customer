...
// //    var ref = new Firebase('https://project-pringles.firebaseio.com/alpha/userGroup');
// //    var $form = $(this);
...
//     var ref = firebase.database().ref("/alpha/userGroup");
//     var data = [];
//     var name = $('#name').val();
//     var email = $('#email').val();
//     var password = $('#password').val();
...
//     firebase.auth().createUserWithEmailAndPassword(email, password).then(function(event) {

                                ...
                                <div class="card-content">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input id="email" type="email" name="email" required="true" class="form-control" value="{{ $email or old('email') }}">
                                        </div>
                                        @if ($errors->has('email'))
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input required  id="password-confirm" type="password" name="password_confirmation" class="form-control">
                                        </div>
